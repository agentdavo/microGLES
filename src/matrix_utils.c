...
void vec3_cross(GLfloat aX, GLfloat aY, GLfloat aZ,
               GLfloat bX, GLfloat bY, GLfloat bZ,
               GLfloat *outX, GLfloat *outY, GLfloat *outZ) {
    *outX = aY * bZ - aZ * bY;
    *outY = aZ * bX - aX * bZ;
    *outZ = aX * bY - aY * bX;
}

GLfloat vec3_dot(GLfloat aX, GLfloat aY, GLfloat aZ,
                GLfloat bX, GLfloat bY, GLfloat bZ) {
...
void vec3_add(GLfloat aX, GLfloat aY, GLfloat aZ,
             GLfloat bX, GLfloat bY, GLfloat bZ,
             GLfloat *outX, GLfloat *outY, GLfloat *outZ) {
    *outX = aX + bX;
    *outY = aY + bY;
...
void vec3_subtract(GLfloat aX, GLfloat aY, GLfloat aZ,
                  GLfloat bX, GLfloat bY, GLfloat bZ,
                  GLfloat *outX, GLfloat *outY, GLfloat *outZ) {
    *outX = aX - bX;
    *outY = aY - bY;
...
int mat4_inverse(mat4 *mat) {
    ...
    inv[15] = mat->data[0] * inv[0] + mat->data[1] * inv[4] + mat->data[2] * inv[8] + mat->data[3] * inv[12];
 ...
 */
void mat4_perspective(mat4 *mat, GLfloat fovy, GLfloat aspect, GLfloat zNear, GLfloat zFar) {
 ...
 */
void mat4_frustum(mat4 *mat, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat nearVal, GLfloat farVal) {
 ...
 */
void mat4_orthographic(mat4 *mat, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat nearVal, GLfloat farVal) {
    GLfloat rl = right - left;
    GLfloat tb = top - bottom;
    GLfloat fn = farVal - nearVal;
...
/**
 * @brief Performs a perspective divide on the matrix, converting from clip space to normalized device coordinates.
 */
 ...
 */
void quat_from_axis_angle(Quaternion *q, GLfloat angle, GLfloat x, GLfloat y, GLfloat z) {
    GLfloat rad = DEG2RAD(angle);
